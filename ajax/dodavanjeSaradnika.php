...
$rezultat .= "<th></th>";
$rezultat .= "<tr> <td>Име и презиме*: </td>    <td> <input type='text' id='ime_prezime1' class='reqd'/>      </td> </tr>";
$rezultat .= "<tr> <td>Koр. име*: </td>         <td> <input type='text' id='kor_ime1' class='reqd '/>               </td> </tr>";
$rezultat .= "<tr> <td>Лозинка*: </td>          <td> <input type='password' id='lozinka1'  class='reqd loz'/>            </td>   </tr>";
$rezultat .= "<tr> <td>Поновљена лозинка*: </td><td> <input type='password' id='lozinka2'  class='reqd lozinka1'/>            </td>   </tr>";
$rezultat .= "<tr> <td>Е-пошта*: </td>          <td> <input type='email' id='e_mail1' class='reqd '/>                </tr>";
